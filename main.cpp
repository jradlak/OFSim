...
int main()
{
    ...
    rocket.init();
    rocket.updateRotation(glm::dvec3(90.0, 90.0, 0.0));
...
int main()
{
    ...
    glm::dvec3 rocketPos = earth.pointAboveTheSurface(34.5, 40.498, -0.05);
    Rocket rocket("moon_shader", rocketPos, 1);

    rocket.init();
    rocket.updateRotation(glm::dvec3(30.0, -30.0, 0.0f));
