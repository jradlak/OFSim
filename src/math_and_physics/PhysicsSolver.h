...
namespace ofsim_math_and_physics
{
	...
	*/
	...
	public:
		...
		// Update the rocket's orientation based on the last key pressed. 
		// Rotate the rocket's orientation by calcuted angle
		void updateRocketOrientation(i32 _lastKeyPressed);
